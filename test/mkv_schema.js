const Schema = require('../lib/ebml/schema');
...
var newSchema = Object.keys(schema).reduce((acc, k) => {
	//Translating old schema into "TagName" => "TagCode" form
    var item = schema[k];
    item.tag = k;
	acc[item.name] = item;
	return acc;
...
module.exports = new Schema(newSchema);
